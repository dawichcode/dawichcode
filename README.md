<div align="center">
  <h1>👋 Hello, I'm @dawichcode</h1>
  
  [![GitHub Trophy](https://github-profile-trophy.vercel.app/?username=wcodewiz&theme=darkhub&row=1&column=6)](https://github.com/wcodewiz)
</div>

## 💫 About Me

I am a passionate developer proficient in multiple programming languages, excelling in both back-end and front-end development. My expertise includes:

- 🔙 **Backend**: Java, JavaScript, Python, PHP, Go, and Rust
- 🎨 **Frontend**: ReactJS and Dart/Flutter
- 🏗️ **Architecture**: Building scalable applications and efficient APIs
- 👥 **Collaboration**: Open-source contributor and mentor
...
- **Full Fledge Platform GO**: A comprehensive platform built with Go
- **Live Streaming Theatre**: An innovative streaming application using PHP/DART & Flutter
